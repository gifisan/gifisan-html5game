...
Game.ui.PVZScene = Game.extend(Game.ui.Scene,{
	...
	createScene:function(){
		this.marginLeft = parseInt(150*this.rate);
		this.marginTop = parseInt(92*this.rate);
		this.marginRight = this.width - parseInt(150*this.rate);
		this.marginBottom = this.height - parseInt(92*this.rate);
		this.itemArray = [];
		this.monsters = {};
	},
...
//道路
Game.ui.Road = Game.extend(Game.ui.MultiImage,{
	clickAble:true,
	mousemoveAble:true,
	flash:false,
	height:76,
...
//炮塔
Game.ui.Tower = Game.extend(Game.ui.MultiImage,{
	atk:3,
	per:16,
	height:72,
	width:72,
...
//怪兽-海螺
Game.ui.Conch = Game.extend(Game.ui.MultiImage,{
	per:64,
	blood:360,
	cBlood:360,
	autoShow:true,
...
//炮塔的子弹
Game.ui.TowerBullet = Game.extend(Game.ui.MultiImage,{
	per:16,
	autoShow:true,
	autoAnimate:true,
	imgInterval:6,
